...
coasts <- read.csv("C:\\Users\\ajmos\\OneDrive\\Desktop\\amosbo.github.io\\Coastal Borders_Migrated Data.csv")
cali_dat <- read.csv("C:\\Users\\ajmos\\OneDrive\\Desktop\\amosbo.github.io\\california_housing.csv") 
...
server <- function(input, output) {
  ...
  output$caliDist <- renderPlot({
    ...
    ggplot(cali_dat)+
      geom_point(aes_string(x = input$xval, y = input$yval, color = input$col, size = input$size), alpha = 0.5)
